...
>                       deriving (Eq) -- delete this line
>                                     -- create your own instance instead
...
> xc = MBP On On 0 -- change this
> yc = MBP On On 0 -- change this
> zc = MBP On On 0 -- change this
> b1 = xc == yc
> b2 = yc == zc
> b3 = xc == zc
...
> data SecurityLevel = Public | Secret | TopSecret deriving (Eq)
...
>
>  x <: y   = error "define me" 
>  join x y = error "define me"
>  meet x y = error "define me"
